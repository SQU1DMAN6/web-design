...
FtR is a project about freedom, but not the hollow kind.

It is freedom as lived experience: the ability to move your work without asking permission from the wrong layer of the system. The ability to keep what matters close, to reach it from different devices, to share it cleanly, and to continue the day without friction becoming the main event.
...
`ftr` belongs to that same system as the keyboard-oriented client. It is for users who think faster with the terminal open, who want a direct line into InkDrop without losing the precision and rhythm of the command line. It is an alternative way of entering the same world, not a separate world of its own.
...
InkDrop is the Master because it gives the project a home. `ftr` is the client because it gives that home reach. Together they express the larger idea: that freedom is not the absence of structure, but the presence of a structure that serves the person using it.